...
obs_wdlf = np.random.normal(obs_wdlf, obs_wdlf_err)
...
plt.tight_layout()
plt.savefig(os.path.join("test_case", "two_bursts_sfh_with_noise.png"))
...
plt.grid()
plt.tight_layout()
plt.savefig(os.path.join("test_case", "two_bursts_wdlf_with_noise.png"))
...
obs_wdlf2 = np.random.normal(obs_wdlf2, obs_wdlf_err2)
...
plt.ylabel("Relative Star Formation Rate")
plt.tight_layout()
plt.savefig(os.path.join("test_case", "decay_sfh_with_noise.png"))
...
plt.grid()
plt.tight_layout()
plt.savefig(os.path.join("test_case", "decay_sfh_wdlf_with_noise.png"))
...
obs_wdlf3 = np.random.normal(obs_wdlf3, obs_wdlf_err3)
...
sampler3.run_mcmc(rel_norm3, 100000, progress=True)

flat_samples3 = sampler3.get_chain(discard=10000, flat=True)
...
plt.ylabel("Relative Star Formation Rate")
plt.tight_layout()
plt.savefig(os.path.join("test_case", "decay_plus_burst_sfh_with_noise.png"))
...
plt.grid()
plt.tight_layout()
plt.savefig(os.path.join("test_case", "decay_plus_burst_sfh_wdlf_with_noise.png"))
